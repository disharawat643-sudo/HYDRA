...
const EntityGraph: React.FC<EntityGraphProps> = ({ searchTerm = '', filterTypes = [] }) => {
    ...
    return (
        <Card className="h-[600px] flex flex-col relative overflow-hidden group">
            <div className="flex justify-between items-center mb-4 z-10">
                ...
                <div className="flex gap-2">
                    <button className="p-2 hover:bg-slate-700/20 rounded-lg text-text transition-colors"><ZoomIn size={18} /></button>
                    <button className="p-2 hover:bg-slate-700/20 rounded-lg text-text transition-colors"><ZoomOut size={18} /></button>
                    <button className="p-2 hover:bg-slate-700/20 rounded-lg text-text transition-colors"><Maximize size={18} /></button>
                </div>
            </div>
