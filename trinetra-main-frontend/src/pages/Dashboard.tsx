        ...
        <MainLayout>
            <div className="max-w-[1600px] mx-auto h-full flex flex-col gap-8">
                ...
                <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-text mb-1">{t('Threat Dashboard')}</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <Card className="flex items-center gap-5 bg-gradient-to-br from-crimson/5 to-transparent border border-crimson/10 relative overflow-hidden group">
                        ...
                        <div className="z-10">
                            ...
                            <h3 className="text-3xl font-bold text-text">24</h3>
                        </div>
                    </Card>
                            ...
                            {loading ? (
                                ...
                                <AnimatePresence>
                                    {filteredThreats.map((threat) => (
                                        ...
                                        >
                                            <Card className="group border-l-4 border-transparent hover:border-l-primary hover:shadow-neumorphic-hover transition-all duration-300">
